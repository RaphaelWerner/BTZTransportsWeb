...
import { InformacoesEmpresaComponent } from './paginas/informacoes-empresa/informacoes-empresa.component';

export const routes: Routes = [
    { path: '', component: LoginPageComponent },
    { path: 'login', component: LoginPageComponent },
    { path: 'app', component: InicialPageComponent, 
    children: [
    { path: 'informacoes',component: InformacoesEmpresaComponent},
