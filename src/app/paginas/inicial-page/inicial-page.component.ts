...
export class InicialPageComponent {
  ...
  navegarMotoristas() {
    console.log("opa");
    this.router.navigate(['motoristas'], { relativeTo: this.route });
  }
  
  navegarCadastroMotoristas() {
    this.router.navigate(['motoristas', 'cadastro'], { relativeTo: this.route });
  }
  ...
  navegarCadastroVeiculos() {
    this.router.navigate(['veiculos', 'cadastro'], { relativeTo: this.route });
  }
  
  navegarAbastecimentos() {
    this.router.navigate(['abastecimentos'], { relativeTo: this.route });
  }
